...
<div class="container">
    <form:form action="/geolocation/countrySearch/search" modelAttribute="geoData" method="post">
        <div class="form-group">
            <label>Searching object</label>
            <form:input path="query" cssClass="form-control"/>
        </div>
        <button type="submit" class="btn btn-dark">Search log</button>
    </form:form>
</div>
